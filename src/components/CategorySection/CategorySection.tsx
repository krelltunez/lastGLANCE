        ...
        <div className="flex flex-col gap-2">
          ...
          {editMode && (
            <button
              ...
              className="flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm text-slate-500 hover:text-slate-200 hover:bg-slate-700/40 border border-dashed border-slate-700/60 hover:border-slate-600 transition-colors"
            >
              <Plus size={14} />
              Add chore
            </button>
